...
tl = TagLifter(ontology = "../../ontology/resource-projects-ontology.rdf",source = "sources/statoil-2014-project-overview-refined.csv",base="http://www.resourceprojects.org/",source_meta={})
